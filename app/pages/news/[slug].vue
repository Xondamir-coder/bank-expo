<template>
  <main id="news-single" class="news">
    <NavBreadcrumbs :breadcrumbs="breadcrumbs" />
    <div class="news__container">
      <div class="news__wrapper">
        <div class="news__top">
          <NuxtLink class="news__top-back" :to="$localePath('/news')">
            <IconsArrowLeft />
        ...
        <div class="news__content">
          ...
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate natus omnis aperiam
            libero harum illum quidem sed obcaecati autem exercitationem, laudantium temporibus
            accusantium soluta facere, incidunt ratione nobis assumenda repellendus sapiente fugiat
            quaerat laborum. In expedita sed, delectus impedit temporibus similique voluptatem aut
            officia incidunt porro rem nulla, amet laudantium.
          </p>
          <div>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ad tempora, veniam repudiandae
            eligendi ipsa mollitia, culpa possimus at esse asperiores natus officiis, molestiae eius
            dicta!
          </div>
          <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Animi omnis sint aliquid eos
            sequi voluptates dolor cupiditate atque quas quidem incidunt, autem accusantium placeat
            quasi aperiam provident quaerat alias ex.
          </p>
        </div>
      </div>
    ...
    <div class="news__bottom">
      ...
      <ClientOnly>
        <swiper-container ref="sliderRef" class="news__bottom-list" :init="false">
